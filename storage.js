...
function storage() {
    ...
    var update_note_color = function (noteId, color) {
        chrome.storage.sync.get('notes', function (data) {
            if (!$.isEmptyObject(data)) {
                var noteData = {};
                noteData[noteId] = {
                    'title': data['notes'][0][noteId]['title'],
                    'text': data['notes'][0][noteId]['text'],
                    'color': color
                }
    ...
    //Private implementation of removeAllNotes, removes all notes as well as the checklists
    ...
    var save_checklist = function (callbackFunction) {
        ...
        chrome.storage.sync.get('checklists', function (data) {
            ...
            if ($.isEmptyObject(data)) {
                ...
                debugger;
                checkData[checkId] = {};
                checkData[checkId][checkItemId] = {
                    'title': '',
                    'checked': false
                };
                chrome.storage.sync.set({
                    'checklists': [checkData]
                }, function () {
    ...
    //Private implementation of crossout
    ...
    //Private implementation of addCheck
